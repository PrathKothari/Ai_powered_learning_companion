// Enhanced Dashboard.js with calendar streaks and smart summaries
...
const Dashboard = ({ studyData = {}, taskData = [] }) => {
  ...
  // Create activity log: one date per day of activity
  const activityDates = [...new Set(
    taskData
      .filter(task => task.completedTime > 0)
  ...
  return (
    <div className="p-6 bg-gradient-to-b from-white to-indigo-50 min-h-screen space-y-6">
      {/* Summary Tiles */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card title="Streak">
          <p className="text-2xl">🔥 4 days</p> {/* mock streak */}
        </Card>
      </div>
